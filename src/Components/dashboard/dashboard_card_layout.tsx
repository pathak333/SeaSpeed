...
const DasboardCardLayout = ({ className, comeFrom, id, data,page }: Props) => {
  ...
  return <div className={className + "mb-4"}>
    <div className="flex flex-wrap  justify-start ">
      ...
      <DashboardCard
        ...
        onClick={() => {
          ...
          if (comeFrom === "admin") {
            ...
            navigate(`/adminDashboard/personaldetails/?id=${id}`, { state: { crew: data,page } });
          } else {
      ...
      <DashboardCard
        ...
        onClick={() => {
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/traveldetails/?id=${id}`, { state: { crew: data,page } });
          } else {
      ...
      <DashboardCard
        ...
        onClick={() => {
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/certificates/?id=${id}`, { state: { crew: data ,page} });
          } else {
      ...
      <DashboardCard
        ...
        onClick={() => {
          //workExperiance
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/workExperiance/?id=${id}`, { state: { crew: data,page } });
          } else {
    ...
    <div className="flex flex-wrap  justify-start ">
      ...
      <DashboardCard2
        ...
        onClick={() => {
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/courseCertificate/?id=${id}`, { state: { crew: data,page } });
          } else {
      ...
      <DashboardCard2
        ...
        onClick={() => {
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/medicalDetails/?id=${id}`, { state: { crew: data ,page} });
          } else {
      ...
      <DashboardCard2
        ...
        onClick={() => {
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/unionRegistrationDetail/?id=${id}`, { state: { crew: data,page } });
          } else {
      ...
      <DashboardCard2
        ...
        onClick={() => {
          if (comeFrom === "admin") {
            navigate(`/adminDashboard/references/?id=${id}`, { state: { crew: data ,page} });
          } else {
