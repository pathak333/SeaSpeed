...
export default function UserInfoCard(p: Props) {



    return <div className="section_our_solution">
        <div className="row">
                    ...
                    <div className="solution_cards_box">
                        <div className="solution_card">
                            ...
                            <div className="flex flex-row justify-between">
                                ...
                                <div className="so_top_icon">
                                    <img src={p.data && p.data.avatar ? p.data.avatar : "https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"} alt="seaSpeed Profile " className="p-3 w-28 h-28 rounded-full" />
                                </div>
                            </div>
                            ...
                            <div className="solu_description">
                                ...
                                <hr className=" w-full " />
                                {p.data !== null && p.data.joiningPort && <p id="name" className="py-2 text-sm">{`SIGN-ON-PORT:  ${p.data.joiningPort}`}</p>}
                                {/* <p>
