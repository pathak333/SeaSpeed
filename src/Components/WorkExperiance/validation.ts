...
export const WorkExperianceValidation = (data: any) => joi.object({
    ...
    dwt: joi.string().optional().allow(""),
    grt: joi.string(),
    bhp: joi.string().optional().allow(""),
    engineType: joi.string().optional().allow("").valid("CAT","CAT 3516","CAT 360","Daihatsu","EMD","KUMERA","MACH","Rolls-Royce","6NVD","ABC",
