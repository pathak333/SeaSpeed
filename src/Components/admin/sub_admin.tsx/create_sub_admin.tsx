        ...
        <div className="box-border border border-[1] border-[#C7C7C7] bg-white rounded-2xl p-[50px] max-sm:p-[20px]">
            ...
            <div className="flex ml-2">
                <div className="permission border-r-2 border-gray-500 w-fit  my-3 px-2">
                    <input className="m-2" type="checkbox" name="User" id="user" />
                    <label htmlFor="user">User</label>
                </div>
                <div className="permission border-r-2 border-gray-500 w-fit  my-3 px-2">
                    <input className="m-2" type="checkbox" name="company" id="company" />
                    <label htmlFor="company">Company</label>
                </div>
                <div className="permission border-r-2 border-gray-500 w-fit  my-3 px-2">
                    <input className="m-2" type="checkbox" name="rank" id="rank" />
