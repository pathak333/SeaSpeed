...
const DashboardCard2 = (props: DashboardCard2Props) => {
  return (
    <div
      className="block w-[270px] max-sm:w-[148px] max-md:w-[160px] p-5 m-2 bg-white rounded-lg shadow-sm hover:bg-grey-200 dark:bg-grey-800 dark:border-gray-700 dark:hover:bg-gray-100 cursor-pointer"
